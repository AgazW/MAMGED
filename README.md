...
For more help, reference manual is available under "Help" section of the [MAMGED](http://mamged.ibab.ac.in). Help about getting started with the stand alone version can be found under "Stand-Alone Version" section of the [MAMGED](http://mamged.ibab.ac.in).
